...
export const LOCATIONS_CS: GamingLocation[] = [
    {
        ...
        specs: ['29 PC', '240Hz & 380Hz Monitory', '10Gbps Internet (Tuned)', 'Barista káva'],
        imgUrl: '/bg/P3.webp',
        phone: '777 766 113',
        mapLink: 'https://share.google/1sTUyG7cfbPHZSNce',
        openHours: 'NONSTOP 24/7',
        openYear: '2011',
        metro: 'Florence / Hlavní nádraží',
    ...
    },
    {
        ...
        specs: ['27 PC', '240Hz & 380Hz Monitory', 'VIP PC (2.5k 240Hz)', 'Konzole s 65" TV'],
        imgUrl: '/bg/P4.webp',
        phone: '777 766 114',
...
export const LOCATIONS_EN: GamingLocation[] = [
    {
        ...
        specs: ['29 PCs', '240Hz & 380Hz Monitors', '10Gbps Internet (Tuned)', 'Barista Coffee'],
        imgUrl: '/bg/P3.webp',
        phone: '777 766 113',
        mapLink: 'https://share.google/1sTUyG7cfbPHZSNce',
        openHours: 'NONSTOP 24/7',
    ...
    },
    {
        ...
        specs: ['27 PCs', '240Hz & 380Hz Monitors', 'VIP PC (2.5k 240Hz)', 'Consoles with 65" TV'],
        imgUrl: '/bg/P4.webp',
        phone: '777 766 114',
        mapLink: 'https://share.google/XBcvMnkhHHB3eL13P',
    ...
    },
    {
        ...
        type: LocationType.PUBLIC,
        address: 'Prusíkova 2577/16, Prague 13',
